d3.json('budget-2022.json').then((data) => {
  const height = 400,
    width = 600,
    innerRadius = 125,      // 0 for closed pie chart
    outerRadius = 175,      // outer radius
    labelRadius = 200;      // where the labels sit
  ...
  svg.append("g")
    .attr("stroke", "white")    // +2 below do space blow graph
    .attr("stroke-width", 2)
    .attr("stroke-linejoin", "round")
    .selectAll("path")
    .data(arcs)
    .join("path")     // Select all paths
