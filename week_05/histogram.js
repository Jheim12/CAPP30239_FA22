...
d3.json('climate-jan.json').then((data) => {
    ...
    g.append("rect")
        ...
        .attr("y", height - margin.bottom)  //Start y position
        .transition()      // Animation settings
        .duration(750)  // Animation settings
        .attr("y", d => y(d.length))    // Final y position
        .attr("height", d => height - margin.bottom - y(d.length));     // Final height
